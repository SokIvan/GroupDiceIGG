...
class Database:
    ...
    async def update_user_status(self, tg_id: int, status: str) -> bool:
        try:
            ...
            self.client.table("users").update(data).eq("tg_id", tg_id).execute()
            return True
        except Exception as e:
    ...
    async def delete_user(self, tg_id: int) -> bool:
        try:
            self.client.table("users").delete().eq("tg_id", tg_id).execute()
            return True
        except Exception as e:
    ...
    async def add_fake_name(self, name: str) -> bool:
        try:
            data = {"name": name}
            self.client.table("fake_names").insert(data).execute()
            return True
        except Exception as e:
    ...
    async def delete_fake_name(self, name: str) -> bool:
        try:
            self.client.table("fake_names").delete().eq("name", name).execute()
            return True
        except Exception as e:
